        ...
        <td class="dxscSingleCell">
            <table class="dxscLabelControlPair" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="dxscControlCell">
                        <dxe:ASPxTextBox ID="tbField1" runat="server" Width="100%" Text='<%# ((UserAppointmentFormTemplateContainer)Container).Field1 %>' BackColor="Ivory" ClientInstanceName="tbField1">
                        </dxe:ASPxTextBox>
                    </td>
                </tr>
            </table>
